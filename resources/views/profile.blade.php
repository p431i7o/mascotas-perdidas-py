 ...
 <div class="container mt-5">
    ...
    <form action="{{ route('profile') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12"><input class="form-control" name="email" type="email" value="{{ $user->email }}" maxlength="300" readonly></div>
        </div>

        <div class="form-group">
            <div class="col-md-3"><label>Nombre</label></div>
            <div class="col-md-12"><input class="form-control" name="name" type="text" value="{{ old('name',$user->name) }}" maxlength="255">
                @error('name')
...
{{--        </div>--}}
        ...
        <div class="form-group">
            ...
            <div class="col-md-12"><input class="form-control" name="password" type="password" value="" >
                @error('password')
                    <div class="alert alert-danger">
                        <strong>{{ $message }}</strong>
                    </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-12"><input class="form-control" name="password_confirmation" type="password" value="" >
